...
$('.section3_block').click(function () {
    $('.section3_block').removeClass('active');
    $(this).addClass('active');
});
...
$(document).ready(function () {
    ...
    $("form").submit(function () { //Change
        ...
        grecaptcha.ready(function () {
            grecaptcha.execute('6LdDBuEcAAAAADj1mk5XHaPEhG4hBhQ_qoL_qmmy', {action: 'submit'}).then(function (token) {
                console.log("captcha success");
                var th = $(this);
                $.ajax({
                    type: "POST",
                    url: "mail.php?token=" + token, //Change
                    data: th.serialize()
                }).done(function () {
                    window.open("https://alfa-force.ru/thank-you.html", "_self")
                    setTimeout(function () {
                        // Done Functions
                        th.trigger("reset");
                    }, 1000);
